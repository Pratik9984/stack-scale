...
export default function Home() {
  ...
  // Reusable animation variants for scrolling
  const fadeUpVariant = {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden relative">
      ...
      <header className="w-full relative z-40 bg-slate-50">
        ...
        {isMenuOpen && (
          <motion.div 
            ...
            className="md:hidden absolute top-full left-0 w-full bg-white shadow-xl border-t border-slate-100 py-4 px-6 flex flex-col gap-4 font-medium text-slate-600 z-50"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-32 flex flex-col items-center text-center relative z-10">
        <motion.div 
          ...
          className="inline-block mb-6 px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 font-semibold text-xs sm:text-sm tracking-wide uppercase"
        >
        ...
        <motion.h1 
          ...
          className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight mb-6 sm:mb-8 leading-tight max-w-4xl"
        >
        ...
        <motion.p 
          ...
          className="text-lg sm:text-xl text-slate-600 mb-8 sm:mb-10 max-w-2xl leading-relaxed px-2"
        >
      ...
      <section id="services" className="py-16 sm:py-24 bg-white overflow-hidden">
        ...
        >
          <motion.div variants={fadeUpVariant} className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <motion.div variants={fadeUpVariant} className="p-6 sm:p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="block group relative bg-gradient-to-tr from-purple-600 via-pink-500 to-orange-400 p-[2px] rounded-3xl shadow-2xl transition-transform duration-300"
              >
