...
export const metadata: Metadata = {
  title: "Pratik Umesh Shinde | Web Development & Digital Marketing",
  description: "I partner with ambitious brands to build blazing-fast websites and digital marketing strategies that turn visitors into loyal customers.",
  ...
  openGraph: {
    ...
    siteName: "Pratik Shinde Freelance",
    type: "website",
  },
};
